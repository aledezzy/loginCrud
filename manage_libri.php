<?php  include "includes/connection.php";
    ...
    if(isset($_POST['confirmBookEdit'])){
        ...
        $query = "UPDATE libri SET isbn = ?, titolo = ?, autore = ?, anno_pubblicazione = ?, genere = ?, quantita = ? WHERE id = ?";
                            ...
                            <table class="userTable">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <form method="post">
                                        <td><button type='submit' name='deleteBookButton'
                                                value="<?php echo $row['id'] ?>">Elimina</button></td>

                                    </form>
                                    <form action="" method="post">
                                        <td><button type='submit' name='modifyBookButton'
                                                value="<?php echo $row['id'] ?>">Modifica</button></td>
                                        ...
                                        <td><input type="hidden" name="anno_pubblicazione" value="<?php echo $row['anno_pubblicazione'] ?>"></td>
                                ...
                                if(isset($_POST['modifyBookButton'])){
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <td><input type="text" name="anno_pubblicazione" value="<?php echo $_POST['anno_pubblicazione'] ?>"></td>
                                        <td>
                                            <select name="genere" id=""><?php include "includes/generi.php"?></select>
                                        </td>
