                ...
                while ($row = $result->fetch_assoc()) {
                    if ($row['ruolo'] != 'admin') {
                        ...
                        <tr>
                            ...
                            <form method="post">
                                <td><button type='submit' name='deleteUserButton' value="<?php echo $row['id']; ?>">Elimina</button>
                                </td>
                                <?php
                                if ($row['stato'] == 'si') {
                                    ?>
                                    <td><button type='submit' name='enableUserButton' value="<?php echo $row['id']; ?>">Abilita</button>
                                    </td>
                                    <?php
                                } else {
                                    ?>
